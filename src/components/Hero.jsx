        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            <div className="relative w-full max-w-[400px] aspect-square rounded-[2.5rem] bg-gradient-to-tr from-medical-600 to-indigo-500 overflow-hidden shadow-2xl flex items-center justify-center group">
              ...
              {/* Floating badges */}
              <motion.div 
                className="absolute top-8 left-8 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm p-3 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 hidden sm:flex items-center gap-2"
                animate={{ y: [0, -6, 0] }}
              ...
              <motion.div 
                className="absolute bottom-8 right-8 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm p-3 rounded-2xl shadow-lg border border-slate-100 dark:border-slate-700 hidden sm:flex items-center gap-2"
                animate={{ y: [0, 6, 0] }}
