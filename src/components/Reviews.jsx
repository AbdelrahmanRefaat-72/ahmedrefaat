        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {reviewsList.map((review, idx) => (
            <motion.div
              ...
              className="bg-slate-50 dark:bg-slate-850 rounded-3xl p-6 sm:p-8 border border-slate-100 dark:border-slate-850 shadow-sm relative group hover:shadow-lg hover:scale-[1.01] hover:border-medical-100 dark:hover:border-medical-950 transition-all duration-300 flex flex-col justify-between"
            >
