          ...
          {cards.map((card, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white dark:bg-slate-800 rounded-3xl p-8 border border-slate-100 dark:border-slate-750 shadow-sm hover:shadow-xl hover:scale-[1.03] hover:border-medical-200/50 dark:hover:border-medical-800/50 transition-all duration-300 flex flex-col group"
              >
