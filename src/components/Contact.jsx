    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch">
              ...
              {contactDetails.map((detail, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className="bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-750 p-5 rounded-2xl shadow-sm flex flex-col xs:flex-row xs:items-center justify-between gap-4 hover:shadow-md hover:scale-[1.01] transition-all duration-300"
                  >
          ...
          <motion.div 
            className="lg:col-span-7 bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-750 rounded-[2rem] p-6 sm:p-8 md:p-10 shadow-sm flex flex-col justify-between"
